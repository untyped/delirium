...
(require (only mzlib/etc opt-lambda)
         ...
         srfi/13/string
         srfi/26/cut
         (planet schematics/schemeunit/plt/location)
         (planet schematics/schemeunit/plt/test)
         (planet schematics/schemeunit/plt/monad)
         (planet schematics/schemeunit/plt/hash-monad)
         (planet schematics/schemeunit/plt/counter)
         (planet schematics/schemeunit/plt/name-collector)
         (planet schematics/schemeunit/plt/text-ui-util))
