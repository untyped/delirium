...
@defproc[(serve/delirium [start                      (request? -> response/c)]
                         ...
                         [#:file-not-found-responder file-not-found-responder (U (request? -> response/c) #f) #f])
         void?]{
...
@defproc[(make-delirium-controller [application-controller (request? -> response/c)]
                                   [test schemeunit-test?]
