...
@section[#:tag "instaweb/delirium"]{Using Delirium with Instaweb}

Delirium has been built to work with @italic{Instaweb.plt}. Simply change your Instaweb import statement from:

@schemeblock[(planet schematics/instaweb/instaweb)]

to:

@schemeblock[(planet untyped/delirium/instaweb)]

and change your call to @scheme[instaweb] to a call to @scheme[instaweb/delirium]. This procedure takes a few extra arguments that let you configure the test-suite to run and choose production mode or test mode. @scheme[instaweb/delirium] automatically sets up all the client- and server-side code for Delirium and creates a test page under a specified URL... it can even open the test page automatically in your web browser.
